...
export const solve = () => {
  ...
  console.log(
    "Part 1:",
    count2dIntersections(input, 200000000000000, 400000000000000),
  );
  ...
  const [py, vx, , px] = solns.map((i) => Math.round(i));
